...
import com.example.test1.ui.home.SELECTBUS.SB2;
...
public class BUS2 extends Fragment implements View.OnClickListener {
    @Nullable
        @Override
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            View view = inflater.inflate(R.layout.bus2, container, false);
            ...
            //Button b8 = (Button) view.findViewById(R.id.buttonB18);
            //Button b9 = (Button) view.findViewById(R.id.buttonB19);
